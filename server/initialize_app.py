...
from analytics.performance import sharpe_ratio_annualized, sortino_ratio_annualized
import numpy as np
init_std_logger()
        ...
        return {
            "analytics": {
                ...
                "performance": {
                    ...
                    "sortino_ratio_annualized": sortino_ratio_annualized(portfolio.total_assets_series, backtest_strategy_data.risk_free_rate),
                }
            },
            "raw_data": {
